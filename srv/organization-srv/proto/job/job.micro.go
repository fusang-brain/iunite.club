...
/*
Package kit_iron_srv_organization_job is a generated protocol buffer package.

It is generated from these files:
	srv/organization-srv/proto/job/job.proto
...
func NewJobService(name string, c client.Client) JobService {
	...
	if len(name) == 0 {
		name = "kit.iron.srv.organization.job"
	}
	return &jobService{
		c:    c,
		name: name,
