...
/*
Package kit_iron_srv_organization_department is a generated protocol buffer package.

It is generated from these files:
	srv/organization-srv/proto/department/department.proto
...
func NewDepartmentService(name string, c client.Client) DepartmentService {
	...
	if len(name) == 0 {
		name = "kit.iron.srv.organization.department"
	}
