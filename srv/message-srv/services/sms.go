...
// func (s *SMSService) SendVertifyCode(mobile string) {
// 	validateCode := utils.GenerateRangeNum(100000, 999999)

// }

// func (s *SMSService) SendRegisterCode(mobile string) {
// 	ValidateCodeModel := s.Model("ValidateCode")
// 	ProfileModel := s.Model("Profile")
